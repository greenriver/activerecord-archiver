...
ActiveRecord::Schema.define do
  create_table :men do |t|
    ...
    t.column :woman_id, :integer, :null => false
  end
  create_table :women do |t|
    t.column :name, :string
    t.column :man_id, :integer, :null => false
  end
end
...
begin
  ...
  t = Man.create :name => 'Puck', :woman_id => 1
  
  # import node cycle
  json = '{"Man":[{"name":"Lysander","woman":0,"woman_id":1},{"name":"Demetrius","woman":0,"woman_id":1}],"Woman":[{"name":"Hermia","man":0},{"name":"Helena","man":1}]}'
